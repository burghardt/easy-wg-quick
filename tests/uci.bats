...
@test "run to create basic stable client configuration in UCI" {
    ...
    [ "${lines[3]}" == "	option listen_port '12345'" ]
    [ "${lines[4]}" == "	list addresses '10.127.0.10/24'" ]
    [ "${lines[5]}" == "	list addresses 'fdfc:2965:0503:e2ae::10/64'" ]
    [ "${lines[6]}" == "	list dns '8.8.8.8'" ]
    [ "${lines[7]}" == "	list dns '2001:4860:4860::8888'" ]
    [ "${lines[9]}" == "config wireguard_wg0" ]
    [ "${lines[10]}" == "	option allowed_ips '0.0.0.0/0'" ]
    [ "${lines[11]}" == "	option allowed_ips '::/0'" ]
